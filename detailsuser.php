...
?>
                         ...
                         <h1>Détails du L'utilisateur <?= $user['id'] ?></h1>
                         <p>
                        <a  class="btn btn-primary" href="listuser.php">Liste des utilisateurs <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-columns-reverse" viewBox="0 0 16 16">
                                            ...
                                            <a class="btn btn-success " href="edituser.php?id=<?= $user['id'] ?>">Modifier 
                    ...
                    <a  class="btn btn-danger" href="deleteuser.php?id=<?= $user['id'] ?>">Supprimer 
                        ...
                        <p>Carte d'identité National : <?= $user['cin'] ?></p>
                        <p>NOM : <?= $user['nom'] ?></p>
                        <p>Prenom : <?= $user['prenom'] ?></p>
                        <p>Email : <?= $user['email'] ?></p>
                        <p>Password : <?= $user['pwd'] ?></p>
                        <p>Telephone : <?= $user['telephone'] ?></p>
                        <p>Categorie : <?= $user['categorie'] ?></p>
                        <p>Sujet_ID : <?= $user['sujet_id'] ?></p>
                        <p>Utilisateur activer / desactiver (1/0) : <?= $user['actif'] ?></p>
