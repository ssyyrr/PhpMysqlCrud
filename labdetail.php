...
?>
                         ...
                         <h1>Détails du Laboratoire<?= $laboratoire['id'] ?></h1>
                         <p>
                        <a  class="btn btn-primary" href="lablist.php">Liste des Laboratoires <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-columns-reverse" viewBox="0 0 16 16">
                                            ...
                                            <a class="btn btn-success " href="labedit.php?id=<?= $laboratoire['id'] ?>">Modifier 
                    ...
                    <a  class="btn btn-danger" href="labdel.php?id=<?= $laboratoire['id'] ?>">Supprimer 
                        ...
                        <p>ID    : <?= $laboratoire['id'] ?></p>
                        <p>Intitule    : <?= $laboratoire['intitule'] ?></p>
                        <p>Abreviation : <?= $laboratoire['abreviation'] ?></p>
                        <p>Departement_id : <?= $laboratoire['departement_id'] ?></p>
                        <p>Directeur_labo_id : <?= $laboratoire['directeur_labo_id'] ?></p>
